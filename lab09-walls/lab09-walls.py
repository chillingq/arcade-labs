...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        # Create the player
        self.player_sprite = arcade.Sprite("dorito.png", SPRITE_SCALING_PLAYER)
        self.player_sprite.center_x = 50
        self.player_sprite.center_y = 64
        self.player_list.append(self.player_sprite)

        # Manually create and position a box at 300, 200
        wall = arcade.Sprite("pepsi.png", SPRITE_SCALING_BOX)
        wall.center_x = 300
        wall.center_y = 200
        self.wall_list.append(wall)

        # Manually create and position a box at 340, 200
        wall = arcade.Sprite("pepsi.png", SPRITE_SCALING_BOX)
        wall.center_x = 340
        wall.center_y = 200
        self.wall_list.append(wall)
